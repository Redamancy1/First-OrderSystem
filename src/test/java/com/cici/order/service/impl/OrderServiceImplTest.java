...
class OrderServiceImplTest {
    ...
    void create() {
        ...
        orderDTO.setBuyerName("lixin");
        orderDTO.setBuyerAddress("仲恺教学楼");
        orderDTO.setBuyerPhone("12341211232");
...
//        o1.setProductName("ggqq");
//        o1.setProductPrice(new BigDecimal(4.5));
